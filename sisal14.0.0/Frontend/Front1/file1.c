...
Void setdefloc(inbucket, line, column)
symtblbucket *inbucket;
int line, column;
{
...
Void addref(inbucket, line, column)
symtblbucket *inbucket;
int line, column;
{
  reflist *ref;
...
Void setlowerbound(level, lower)
treestackobj *level;
inforecord *lower;
{
...
Void findname(ident, itype, level, place)
stryng ident;
identtype itype;
treestackobj **level;
symtblbucket **place;
...
Void pushtypename(inputtoken, line, column)
stryng inputtoken;
int line, column;
{
...
Void checktypename(inputtoken, line, column)
stryng inputtoken;
int line, column;
{
...
Void buildfort(ifttype, flgaddtotable)
char ifttype;
boolean flgaddtotable;
{
...
Void dobinaryop(token, line, col)
int token, line, col;
{
...
Void findfieldname(name, fields, found, place)
stryng name;
stentry **fields;
boolean *found;
int *place;
...
Void errindexnames(indexnames, col)
...
Void checkexptype(exp, line, col)
explistnode **exp;
int line, col;
{
  errorrecord *errorrec;
...
Void makearrayfor(indexnames, exp, name, line, column)
namelistrec *indexnames;
explistnode *exp;
namelistrec *name;
int line, column;
...
Void makerangefor(exp, exp2, name, line, col)
...
Void increasegenerator(line, col)
int line, col;
{
...
Void switchtoreturngraph(level)
treestackobj *level;
{
...
Void dopredefined(symptr, semexplist, line_)
symtblbucket *symptr;
semanticrec *semexplist;
int line_;
{
...
Void addtodefinelist(inputtoken)
stryng inputtoken;
{
  /*action 23*/
...
Void startfunction(inputtoken, action, line, col)
stryng inputtoken;
int action, line, col;
{
...
Void startforwardfunct(inputtoken, line, col)
stryng inputtoken;
int line, col;
{
...
Void doresultlist(typelist, symptr)
typelistrec *typelist;
symtblbucket *symptr;
{
...
Void freefuncttype(functtypeptr)
...
Void endiftagsubgraph(predflag)
boolean predflag;
{
  /*stackpops - tgexplist
                  pushes - nothing*/
...
Void checkold(inputtoken, line, column)
stryng inputtoken;
int line, column;
{
  /*action 122 CheckOld*/
...
Void createiserror(line, column)
int line, column;
{
