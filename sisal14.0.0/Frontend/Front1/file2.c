...
staticforward Void printsym PROTO((int sym));

staticforward Void scan PROTO((SHORT *token, int *tokenlineno, inputbuffer **buffer));

staticforward Void myabort PROTO((void));

staticforward Void getline PROTO((inputbuffer **buffer));

staticforward Void peek PROTO((SHORT *sym));

staticforward Void deletetokens PROTO((int pighowmany));

staticforward Void inserttokens PROTO((stagerec fix));

staticforward Void printline PROTO((inputbuffer *buffer));
...
=======================================================*/
Void storehisto(deltried, deldone, inserts)
...
Void getprefixinfo(term, directoryname)
char term;
stryng directoryname;
{
  /*------------------------------------------------------------------
...
Void readerrtables(directoryname)
stryng *directoryname;
{
  /*----------------------------------------------------------------
...
Void expandinsertion(minpos, insert)
SHORT minpos;
stagerec *insert;
{
  /*----------------------------------------------------------------
...
Void llinsert(errsym, insertion, directoryname)
char errsym;
stagerec *insertion;
stryng *directoryname;
{
...
Void llcorrector(token, directoryname)
SHORT *token;
stryng *directoryname;
{
  /*-------------------------------------------------------------------
...
Void printfraction(num, divider)
int num, divider;
{
  /*----------------------------------------------------------------------
...
Void insertcharbuf(ch, loc, buffer)
Char ch;
unchar loc;
inputbuffer *buffer;
{
...
Void displaydeletions(pighowmany)
int pighowmany;
{
  /*----------------------------------------------------------------
...
/*-----------------------------------------------------------*/
Void scan(token, tokenlineno, buffer)
SHORT *token;
int *tokenlineno;
inputbuffer **buffer;
{  /* Scanner */
...
Void parseerror(token, directoryname)
SHORT token;
stryng *directoryname;
{
  /*---------------------------------------------------------------
...
boolean csemodule(module, verbose)
node *module;
boolean verbose;
{
