...
extern treestackobj *currentlevel;
extern int linenumber, tokenlineno;

extern Void deletestring PROTO((stryng*,int,int));
extern Void dumpmodule PROTO((void));
extern boolean equalstrings PROTO((stryng*,stryng*));
extern stentry* getbasictype PROTO((int));
extern Void insertchar PROTO((stryng*,int,int));
extern void mymemcpy PROTO((char*,char*,int));
extern graph* newgraphptr PROTO((void));
extern Void newnamelist PROTO((namelistrec**));
extern Void removenode PROTO((node*));
extern Void string10 PROTO((stryng*,Char*));
extern Void string20 PROTO((stryng*,Char*));
extern Char stringchar PROTO((stryng*,int));
extern Void stringlowercase PROTO((stryng*));
extern Void stringspaces PROTO((stryng*));
extern Void substring PROTO((stryng*,stryng*,int,int));
extern Void writestring PROTO((FILE*,stryng*));
extern PSBLOCK MySBlockAlloc PROTO((void));
extern PBBLOCK MyBBlockAlloc PROTO((void));
extern Void addstamp PROTO((int,stryng));
extern Void removestamp PROTO((int));
extern boolean stampismissing PROTO((int));
extern Void addtoexplist PROTO((explistnode**,explistnode*));
extern Void addtonamelist PROTO((stryng,int,int));
extern stentry *addtotypetable PROTO((stentry*));
extern Void adjustgraphptrs PROTO((void));
extern boolean announceaction PROTO((int,int,int,int,stryng));
extern Void askordefault PROTO((parrec*,stryng*,int,Char*));
extern int assignports PROTO((edgelisthead*,int));
extern boolean canwrite PROTO((stryng*));
extern Void changeedgedest PROTO((port*,node*,int));
extern Void changeedgesrc PROTO((port*,node*,int));
extern Void compactports PROTO((node*));
extern Void compacttypetable PROTO((int*,int));
extern Void concatchar PROTO((stryng*,int));
extern node *copynode PROTO((node*));
extern node *copygraph PROTO((node*));
extern node *copycompound PROTO((node*));
extern node *createcompoundnode PROTO((int));
extern node *createsimplenode PROTO((int));
extern boolean debugger PROTO((int,int));
extern Void defaultext PROTO((stryng*,stryng*,Char*));
extern parrec *defineparameter PROTO((parrec**,Char*,Char*,partyp,int,int));
extern Void disconnectedgefromdest PROTO((port*));
extern Void disconnectedgefromsource PROTO((port*));
extern int findstring PROTO((stryng*,stryng*,int));
extern Void freeinfoptr PROTO((inforecord**));
extern Void freenamelist PROTO((namelistrec**));
extern Void freesemantic PROTO((semanticrec**));
extern Void freesymptr PROTO((symtblbucket*));
extern Void freetornlist PROTO((tornrec**));
extern Void freetreestack PROTO((treestackobj*));
extern Void freettptr PROTO((stentry**));
extern Void freetypelist PROTO((typelistrec**));
extern inforecord *getalit1 PROTO((void));
extern stentry *getconstructortype PROTO((int,stentry*));
extern port *getinputedge PROTO((node*,int));
extern port *getoutputedge PROTO((node*,int));
extern node *graphwalk PROTO((node*));
extern Void initmodule PROTO((void));
extern Void initnames PROTO((void));
extern port *insertedge PROTO((node*,int,node*,int,stentry*,stryng));
extern port *insertliteral PROTO((node*,int,stentry*,stryng,stryng));
extern Void insertnode PROTO((node*,node*,node*));
extern Void integerstring PROTO((stryng*,int,int));
extern int largestinputportnumber PROTO((node*));
extern int largestoutputportnumber PROTO((node*));
extern Void linkparent PROTO((node*,treestackobj*));
extern tornrec *linktorntype PROTO((tornrec*,tornrec*));
extern Void linktype PROTO((stentry*,typelistrec**));
extern edgelist *newedgelistptr PROTO((void));
extern port *newedgeptr PROTO((portsort));
extern errorrecord *newerrorptr PROTO((errortypes));
extern explistnode *newexplistptr PROTO((void));
extern edgelisthead *newheadptr PROTO((void));
extern inforecord *newinfoptr PROTO((void));
extern linkrec *newlinkageptr PROTO((linksort));
extern node *newnodealloc PROTO((nodesort));
extern node *newnodeptr PROTO((nodesort,treestackobj*));
extern refrec *newreferencesptr PROTO((void));
extern Void newsemantic PROTO((semanticrec**,typesemanticdata));
extern symlistnode *newsymlistptr PROTO((void));
extern tcstacklistrec *newtcstacklist PROTO((void));
extern Void newtornlist PROTO((tornrec**,torntype));
extern Void newttptr PROTO((stentry**,int));
extern Void newtypelist PROTO((typelistrec**));
extern Void nextbodyportname PROTO((treestackobj*,stryng*));
extern port *nextoutputedgesameport PROTO((port*));
extern int nextreturnport PROTO((treestackobj*));
extern int numberofwiredoutputports PROTO((node*));
extern int numbnodesingraph PROTO((node*));
extern int numbofsubgraphs PROTO((node*));
extern boolean openintread PROTO((FILE**,stryng*));
extern boolean openlistfile PROTO((stryng,FILE**));
extern boolean openread PROTO((FILE**,stryng*));
extern boolean openwrite PROTO((FILE**,stryng*));
extern port *outputedgegeport PROTO((node*,int));
extern semanticrec *popsemantic PROTO((void));
extern node *producernodeofedge PROTO((port*));
extern int producerportnumber PROTO((port*));
extern Void pushemptyexplist PROTO((void));
extern Void pushsemantic PROTO((semanticrec*));
extern Void putintable PROTO((stentry**));
extern Void readcommandline PROTO((parrec**,parrec**,parrec**));
extern Void removedeadcode PROTO((void));
extern Void removeedge PROTO((port**));
extern Void semerror PROTO((errorrecord*));
extern Void shiftinputports PROTO((node*,int,int));
extern Void shiftoutputports PROTO((node*,int,int));
extern Void smashtypes PROTO((void));
extern Void splitname PROTO((stryng*,stryng*,stryng*,stryng*));
extern Void startnamelist PROTO((void));
extern comparetype stringcompare PROTO((stryng*,stryng*,int));
extern long stringnumber PROTO((stryng*,int*,int));
extern Void stringuppercase PROTO((stryng*));
extern node *tobodygraph PROTO((node*));
extern node *tochildgraph PROTO((node*,int));
extern node *toforallbodygraph PROTO((node*));
extern node *toforallgeneratorgraph PROTO((node*));
extern node *toforallreturnsgraph PROTO((node*));
extern node *toinitgraph PROTO((node*));
extern node *tolastnodeingraph PROTO((node*));
extern node *tonextfunction PROTO((node*));
extern node *toprevnode PROTO((node*));
extern node *toreturnsgraph PROTO((node*));
extern node *totestgraph PROTO((node*));
extern Void insertstring PROTO((stryng*,stryng*,int));
extern Void stripspaces PROTO((stryng*));
extern Void cleanupgraph PROTO((node*));
extern void CANN_DumpSpecialPragmas PROTO((FILE*));

extern xrefrec idunsorted[];
extern int idsorted[];
extern int idxrefmax;
extern boolean semtrace;
extern long breakpointset[];
extern int currentstep;
extern int stepcount;
extern stryng inputtoken;
extern int boostfac;
extern boolean cortrace;
extern boolean debug;
extern long arithtypes;
extern long algebtypes;
...
extern int deltriedhisto[];
extern int delmadehisto[];
extern int inshisto[];
extern int numterms;
extern insertstringrec costtable[];
extern FILE* ptableout;
extern FILE* etableout;
extern int deletecosts[];
extern int insertptr;
extern char insertspace[];
extern int numsymbols;
extern int numprods;
extern pretabarray prefixtable;
extern FILE* reservedwords;
extern FILE* inputfile;
extern stryng listfilename;
extern stryng stampstr;
extern stryng versionstr;
extern stryng versionnum;
extern int myinfinity;
extern char curerrsym;
extern boolean errortables;
extern SHORT stackptr;
extern int parsestack[];
extern int savinsertptr;
extern int errorcount;
extern int numdeltried;
extern int tokinserted;
extern int tokdeleted;
extern ptabrec* table[];
extern parrec *directoryparam;
extern parrec* paramlist;
extern int semerrcnt;
extern parrec *xrefparam;
extern parrec* listingparam;
extern parrec* debugparam;
extern parrec* pass1param;
extern boolean passerr;
extern stryng directoryname;
extern stryng defaultdirectoryname;
extern stryng filename;
extern parrec *listfparam;
extern boolean listing;
extern namelistrec *includelist;
extern boolean epsprod[];
extern int stringptr;
extern inputbuffer* linebuf;
extern inputbuffer* oldline;
extern boolean echoed;
extern boolean endfile;
extern stryng curinputfile;
extern stryng newfname;
extern unchar tokenstart;
extern boolean debugcg;
extern boolean commentflag;
extern boolean peeking;
extern boolean firsttime;
extern boolean firsttime;
extern int newlinenum;
extern SHORT oldtoken;
extern int toconsume;
extern int prodspace[];
extern prodrec productions[];
extern rabrec *readaheadbuf;   /*head of buffer of inserted tokens*/
extern int reuseindex;
extern int ordzero;
extern Char stringspace[];
extern stringrec symkluge[];
extern SHORT prodspceptr;
extern long badcharset[];
extern Char newcommand;
extern SHORT savetoken;
extern int singlechar[];   /* token numbers */
extern int rea;
extern int inttokenval;
extern unchar debugflags[];
extern int CANN_GlueMode;
extern tablerec p;
extern boolean done;
extern int statehistory[];
