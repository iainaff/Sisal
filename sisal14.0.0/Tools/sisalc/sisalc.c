...
static int profiling; /* -pg --profiling (false) Compile/link intermediate C code with -pg for profiling. */
...
static option_t options[] = {
   ...
   /* OPTIONS */
    /* Autogenerated using generateOptions.py on Thu Jan  1 20:40:49 2004 */
...
int main(int argc, char** argv) {
   ...
   while(cFiles) {
      ...
      compile(file,result,includeDirectory,profiling,CC,CFLAGS);
